...
<html>
    ...
    <body>
        ...
        <div id="total-container">
            ...
            <div id="welcome">
                <div class="container">
                    <div class="col-xs-12 animate-fadeInUp">
            ...
            <div id="services-choices">
                <div id="owl" class="animate-fadeInDown owl-carousel owl-theme">
            ...
            <div id="services-header">
                ...
                <div id="overview" class="service-slider active">
                    <div class="container">
                        <div class="col-xs-12 animate-fadeIn bg-dark">
                            <h2 class="animate-fadeIn">EVERYTHING <span class="blue thin">YOU NEED</span></h2>
                            <p class="animate-fadeIn thin">Whether you need simple pages, striking galleries, a professional blog, or an online store, it's all possible with my services. Best of all, I can develop everything mobile-ready right from the start.</p>
                        </div>
                ...
                <div id="shops" class="service-slider">
                    <div class="container">
                        <div class="col-xs-12 bg-dark">
                            <h2 class="animate-fadeIn">PROMOTE <span class="blue thin">YOUR SHOP</span></h2>
                            <p class="animate-fadeIn thin">There are so many ways you can promote and advertise your shop. Select those that you are comfortable with and start your internet marketing now.</p>
                        </div>
                ...
                <div id="photographers" class="service-slider">
                    <div class="container">
                        <div class="col-xs-12 bg-dark">
                            <h2 class="animate-fadeIn"> <span class="blue thin">SHOW</span> YOUR PICTURES</h2>
                            <p class="animate-fadeIn thin">Striking galleries, are the best ways to show to the world your pictures. Let your fans and people discover your work with a nice website accesible everywhere. </p>
                        </div>
                ...
                <div id="bloggers" class="service-slider">
                    <div class="container">
                        <div class="col-xs-12 bg-dark">
                            <h2 class="animate-fadeIn"> <span class="blue thin">SHARE</span> YOUR STORIES</h2>
                            <p class="animate-fadeIn thin">Let your content speak for itself. You would like to share your stories and/or experiences? I can create best-in-class blogging platform and superb media management with real-time comments.</p>
                        </div>
                ...
                <div id="artists" class="service-slider">
                    <div class="container">
                        <div class="col-xs-12 bg-dark">
                            <h2 class="animate-fadeIn">EXPOSE <span class="blue thin">YOUR WORK</span></h2>
                            <p class="animate-fadeIn thin">Let your content speak for itself. I can create best-in-class blogging platform features LayoutEngine, superb media management, and real-time comments.</p>
                        </div>
                ...
                <div id="restaurants" class="service-slider">
                    <div class="container">
                        <div class="col-xs-12 bg-dark">
                            <h2 class="animate-fadeIn">BOOST <span class="blue thin">YOUR RESTAURANT</span></h2>
                            <p class="animate-fadeIn thin">You want to increase your restaurant sales by : increase number of new customers, increase frequency of existing customers, increase spend and increase rate of table turn/flow-through ? Start with a website!</p>
                        </div>
                ...
                <div id="musicians" class="service-slider">
                    <div class="container">
                        <div class="col-xs-12 bg-dark">
                            <h2 class="animate-fadeIn">GROW <span class="blue thin">YOUR LISTENERS</span></h2>
                            <p class="animate-fadeIn thin">Let your music traveling around the world! Increase your online audience, share new songs, information about your group and let people know about your upcoming tour dates. </p>
                        </div>
                ...
                <div id="weddings" class="service-slider">
                    <div class="container">
                        <div class="col-xs-12 bg-dark">
                            <h2 class="animate-fadeIn"><span class="blue thin">REMEMBER</span> YOUR HAPPIEST DAY</h2>
                            <p class="animate-fadeIn thin">You are preparing your wedding and you want to share it with your friends and family or just simplify your preparations by creating a website to announce important events and dates related to the happiest day of your life? I can help you to do that!</p>
                        </div>
            ...
            <div id="services-details">
                <div class="container">
                    <div class="col-sm-12 col-sm-6 col-md-4 animate-fadeInUp">
            ...
            <div id="text-separator-timers">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3 text-center timerWrapper animate-fadeIn">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 text-center timerWrapper animate-fadeIn">
            ...
            <div id="portfolio">
                <div class="container">
                    <div class="col-xs-12">
                        <h2 class="part-title animate-fadeIn"><span class="thin">my</span> portfolio </h2>
                        <div class="separator"></div>
                ...
                <div id="portfolio-block">
                    <div class="example">
                        <figure class="item item-w2 item-h3 animate-fadeIn community ">
                            <figcaption>
                        ...
                        <figure class="item item-w1 item-h2 animate-fadeIn investor-group">
                            <figcaption>
                        ...
                        <figure class="item item-w2 item-h3 animate-fadeIn newrestaurants">
                            <figcaption>
                        ...
                        <figure class="item item-w2 item-h2 animate-fadeIn maison">
                            <figcaption>
                        ...
                        <figure class="item item-w1 item-h3 animate-fadeIn chefseries">
                            <figcaption>
                        ...
                        <figure class="item item-w2 item-h2 animate-fadeIn spafax">
                            <figcaption>
                        ...
                        <figure class="item item-w1 item-h2 animate-fadeIn filmfest14">
                            <figcaption>
                        ...
                        <figure class="item item-w2 item-h2 animate-fadeIn gofar">
                            <figcaption>
                        ...
                        <figure class="item item-w1 item-h2 animate-fadeIn filmfest12">
                            <figcaption>
                        ...
                        <figure class="item item-w1 item-h2 animate-fadeIn claudemauffette">
                            <figcaption>
            ...
            <div id="aboutme">
                <div class="container">
                    <div class="col-xs-12">
                        <h2 class="part-title animate-fadeIn">About <span class="thin">me</span></h2>
                        <div class="separator"></div>
                    </div>
                    <div class="col-xs-12 animate-fadeInUp">
                        <p>
            ...
            <div id="cities">
                <ul class="ch-grid animate-fadeInUp">
                    <li>
                        <div class="ch-item">   
            ...
            <div id="contact">
                <div class="container">
                    <div class="col-xs-12">
                        <h2 class="part-title animate-fadeIn">Contact</h2>
                        <div class="separator"></div>
                        <h3 class="thin animate-fadeIn">Get in touch with me!</h3>
                    </div>
                    <div class="col-sm-6 animate-fadeInUp">
                        <h4>GET STARTED</h4>
